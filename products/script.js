...
function displayProducts(products) {
    ...
    for (let p of products) {
        htmlData += `
            ...
            <!-- card -->
            <div class="card border-light col-3" style="width: 18 rem;">
                <img src="${p.image}" alt="product-image">
                <div class="card-footer border-top border-light p-4">
                    <a href="#" class="h5">${p.title}</a>
                    <div class="mb-0 text-gray">${p.description.slice(0,70)}</div>
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <span class="h6 mb-0 text-gray">$${p.price}</span>
